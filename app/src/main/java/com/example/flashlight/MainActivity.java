package com.example.flashlight;/*package com.example.flashlight;
        ...
        toggleButton.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View v) {
                if ( hasCameraFlash){
                    if(flashOn){
                        flashOn=false;
                        toggleButton.setImageResource (R.drawable.poff);
                        flashLightOff();

                    }
                    else{
                        flashOn=true;
                        toggleButton.setImageResource (R.drawable.ponn);
                        flashLightOn();

                    }
                }
                else {
                    Toast.makeText (MainActivity.this,"no flashavailabl on your device",Toast.LENGTH_LONG).show ();
                }
            }
